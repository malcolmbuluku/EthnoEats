...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(modal)/dish` | `/dish` | `/(modal)/filter` | `/filter` | `/(modal)/location-search` | `/location-search` | `/auth/login` | `/home/basket` | `/home/details` | `/home/` | `/user/profile` | `/_layout`;
  // prettier-ignore
